...
export const renderHome = (req, res) => res.render("home", { pageTitle: "Home", videos });
...
export const renderDeleteVideo = (req, res) => res.render("deleteVideo", { pageTitle: "Delete Video" });
